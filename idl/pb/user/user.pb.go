...
type UserResponse struct {
	...
	UserID int64 `protobuf:"varint,1,opt,name=UserID,proto3" json:"user_id"` //1:标号，唯一 即可（相当于数据库中的Id，不一定要从1 ，2的顺序依次排列
...
var file_user_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x5e, 0x0a, 0x0c,
	...
	0x28, 0x09, 0x52, 0x08, 0x4e, 0x69, 0x63, 0x6b, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x8b, 0x01, 0x0a,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0e, 0x5a, 0x0c, 0x69, 0x64, 0x6c, 0x2f, 0x70,
	0x62, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_user_proto_depIdxs = []int32{
	0, // 0: UserDetailResponse.UserDetail:type_name -> UserResponse
	1, // 1: UserService.UserLogin:input_type -> UserRequest
	1, // 2: UserService.UserRegister:input_type -> UserRequest
	1, // 3: UserService.UserLogout:input_type -> UserRequest
	2, // 4: UserService.UserLogin:output_type -> UserDetailResponse
	2, // 5: UserService.UserRegister:output_type -> UserDetailResponse
	2, // 6: UserService.UserLogout:output_type -> UserDetailResponse
